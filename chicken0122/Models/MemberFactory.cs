...
namespace chicken0122.Models
{
    public class MemberFactory
    {
        ...
        //修改、更新資料
        public void Update(CMember22 p)
        {
            List<SqlParameter> paras = new List<SqlParameter>();
        ...
        private List<CMember22> QueryBySql(string sql, List<SqlParameter> paras)
        {
            List<CMember22> CMember22s = new List<CMember22>();
            SqlConnection con = new SqlConnection();
            con.ConnectionString = @"Data Source=chicekserver.database.windows.net;Initial Catalog=dbChicken22;User ID=chicken;Password=P@ssw0rd-iii";
